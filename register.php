            ...
            <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" onaction="register.php" method="post" enctype="multipart/form-data" novalidate>
                  <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                      <div class="col-md-8 col-lg-9">
                        <img src="../uploads/<?=$_SESSION["memberImage"]?>" width="30%" alt="Profile" class="rounded">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="name" type="text" class="form-control" id="name" value="<?=$_SESSION['memberNameR']?>" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="joinDate" type="date"  class="form-control" id="joinDate" value="<?=$_SESSION["JoinDate"]?>" required>
