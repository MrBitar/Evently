        ...
        <div class="col-xl-12">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <li class="nav-item">
                  <button class="nav-link active" name="profile-edit-link" id="profile-edit-link" data-bs-toggle="tab" onclick="location.href = 'events.php';" data-bs-target="home.php">Add Event</button>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade active show  profile-edit pt-3" id="add-admins">
                  ...
                  <!-- Settings Form -->
                  <form action="addEvent.php" class="row g-3 needs-validation" method="post" novalidate enctype="multipart/form-data">
                  <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                      <div class="col-md-8 col-lg-9">
                        <img src="../uploads/<?=$_SESSION['imageEvent']?>" alt="Profile" class="rounded ">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="name" type="text" class="form-control" id="name" value="<?=$_SESSION["event"]?>" required>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dest" type="text" class="form-control" id="dest" value="<?=$_SESSION["dest"]?>" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dateFrom" type="date" class="form-control" id="dateFrom" onchange="getDateTo()"  value="<?=$_SESSION["dateFrom"]?>" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dateTo" type="date" class="form-control" id="dateTo"  value="<?=$_SESSION["dateTo"]?>" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="cost" type="number" class="form-control" id="cost" value="<?=$_SESSION["cost"]?>" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="description" class="form-control" id="description" style="height: 100px"><?=$_SESSION["desc"]?></textarea>
