          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <button class="nav-link active" name="profile-edit-link" id="profile-edit-link" data-bs-toggle="tab" onclick="location.href = 'deleteEvent.php';" data-bs-target="home.php">Delete Event</button>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content pt-2">
                <div class="tab-pane fade active show pt-3 profile-edit" id="delete-admin">
                  ...
                  <form action="eventDelete.php" class="row g-3 needs-validation" method="post" novalidate>
                 
                    <div class="row mb-3">
                      <label for="id" class="col-md-4 col-lg-3 col-form-label">Event's Id</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="id" type="number" class="form-control" id="id" value="<?= $_SESSION['eventDelID']?>" required>
                        <div class="invalid-feedback" id="invalid-id" name="invalid-id" >Please Enter ID</div>
                    </div>
                    </div>
                    <div class="row mb-3">
                      <label for="name" class="col-md-4 col-lg-3 col-form-label">Event's Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="name"  type="text" class="form-control " id="name" value="<?= $_SESSION['eventDelName']?>" required>
                        <div class="invalid-feedback" id="invalid-name" name="invalid-name" >Please Enter Name</div>
                    </div>
                    </div>

                    <div class="row mb-3">
                    <div class="text-center">
                      <button type="submit" class="btn btn-danger" name="submit" id="submit">Delete Event</button>
                    </div>
                    </div>
