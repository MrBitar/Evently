          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <button class="nav-link active" id="add-admin-link" data-bs-toggle="tab" onclick="location.href = 'assign.php';" data-bs-target="#add-admins">Assign Guides</button>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade active show pt-3 profile-edit" id="delete-admin">
                  ...
                  <form action="assignGuide.php" class="row g-3 needs-validation" method="post" novalidate>
                  <div class="row mb-3">
                    ...
                    <br>
                    <div class="row mb-3">
                      <label for="guide" class="col-md-4 col-lg-3 col-form-label">Choose Guide</label>
                      <div class="col-md-8 col-lg-9">
                        <select  name="guide" type="select" class="form-control" id="guide" >
                        <option default>None</option>
                        <?php getGuides();?>    
                    </select>
                      </div>
