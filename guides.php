...
<?php include("guideHome.php");
include("guideEdit.php");
include("guideAdd.php");
?>
  <!-- Google Fonts -->
        ...
        <div class="col-xl-12">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <li class="nav-item">
                  <button class="nav-link active" name="profile-edit-link" id="profile-edit-link" data-bs-toggle="tab" onclick="location.href = 'guides.php';" data-bs-target="home.php">Edit Guides</button>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <button class="nav-link " data-bs-toggle="tab" onclick="location.href = 'deleteGuide.php';" data-bs-target="deleteGuides.php">Delete Guides</button>
                </li>
              ...
              <div class="tab-content pt-2">
                <div class="tab-pane fade active show  profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <div class="row mb-3">
                      <label for="chooseGuide" class="col-md-4 col-lg-3 col-form-label">Choose Guide</label>
                      <div class="col-md-8 col-lg-9">
                        <select onchange="chooseGuide(this)" name="selectGuide" type="select" class="form-control" id="selectGuide" >
                    ...
                    <br>
                  <form action="guideEdit.php" class="row g-3 needs-validation" method="post" novalidate enctype="multipart/form-data">

                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                      <div class="col-md-8 col-lg-9">
                        <img src="../uploads/<?=$_SESSION["imageGuide"]?>" alt="Profile" class="rounded">
                        <div class="pt-2">
...
<script>
    function chooseGuide(e){
       var id = e.value;
window.location.href = "guideHome.php?id="+id;
    }
