          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" onclick="location.href = 'delete.php';" data-bs-target="delete.php">Delete Admins</button>
                </li>

              </ul>
              <div class="tab-content pt-2">

                <div class="tab-pane fade active show pt-3" id="delete-admin">
                  <!-- Change Password Form -->
                  <form action="deleteAdmin.php" class="row g-3 needs-validation" method="post" novalidate>
                 
                    <div class="row mb-3">
                      <label for="adminEmail" class="col-md-4 col-lg-3 col-form-label">Admin's Email</label>
                    ...
                    <div class="row mb-3">
                      <label for="adminPassword" class="col-md-4 col-lg-3 col-form-label">Admin's Password</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-danger" name="submit" id="submit">Delete Admin</button>
                    </div>
                    </div>
