          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <button class="nav-link active" id="add-admin-link" data-bs-toggle="tab" onclick="location.href = 'addGuides.php';" data-bs-target="#add-admins">Add Guides</button>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade active show  profile-edit pt-3" id="add-admins">
                  <?php include("guideAdd.php"); ?>
                  <!-- Settings Form -->
                  <form action="guideAdd.php" class="row g-3 needs-validation" method="post" novalidate enctype="multipart/form-data">
